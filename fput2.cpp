/**
 * This file contains the implementation of the FPUT class and its main function.
 */
...
class FPUT
{
  ...
  vector<vector<double>> A_mat; /**< The matrix used in the calculation of energies. */
